...
/*
 * This class is used to manage the configuration data of the policy in a hybrid manner. New configurations are stored
 * in the database and the old configurations are deleted from the registry upon setting the new configurations.
 */
